...
FILE=`zenity  --filename=$HOME/Zcloud/Travail/ABC/ABC/MonSaltarelle/TRAD --file-selection= --title="Sélectionnez un fichier"`
NOM=${FILE:0:${#FILE}-4} 
